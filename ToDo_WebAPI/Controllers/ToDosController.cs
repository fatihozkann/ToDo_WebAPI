...
namespace ToDo_WebAPI.Controllers
{
    ...
    public class ToDosController : ControllerBase
    {
        ...
        // 403 Giriş yapılmış ama kullanıcının yetkisi yok.
        ...
        public IActionResult AddToDo(AddToDoRequest request)
        {
            ...
            catch (Exception)
            {
                ...
                return StatusCode(StatusCodes.Status500InternalServerError); // return StatusCode(500)
            }
